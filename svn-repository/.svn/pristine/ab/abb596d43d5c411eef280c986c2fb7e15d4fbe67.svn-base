...
class Yatri_Tools_Install_Demos {
	...
	public function create_admin_page() {
		...
		<div class="yatri-tools-demo-wrap wrap">
			...
			<h2><?php //echo esc_attr( $brand ); ?> - <?php esc_attr_e( 'Install Demos', 'yatri-tools-toolkit' ); ?></h2>
				...
				<?php if ( ! empty( $categories ) ) : ?>
					<div class="yatri-tools-header-bar">
						<nav class="yatri-tools-navigation">
							<ul>
								<li class="active"><a href="#all" class="yatri-tools-navigation-link"><?php esc_html_e( 'All', 'yatri-tools-toolkit' ); ?></a></li>
								<?php foreach ( $categories as $key => $name ) : ?>
									<li><a href="#<?php echo esc_attr( $key ); ?>" class="yatri-tools-navigation-link"><?php echo esc_html( $name ); ?></a></li>
								<?php endforeach; ?>
							</ul>
						</nav>
						<div clas="yatri-tools-search">
							<input type="text" class="yatri-tools-search-input" name="yatri-tools-search" value="" placeholder="<?php esc_html_e( 'Search demos...', 'yatri-tools-toolkit' ); ?>">
						</div>
					</div>
				<?php endif; ?>
						...
						<div class="theme-wrap" data-categories="<?php echo esc_attr( $item_categories ); ?>" data-name="<?php echo esc_attr( strtolower( $demo ) ); ?>">
							...
							<div class="theme yatri-tools-open-popup" data-demo-id="<?php echo esc_attr( $demo ); ?>">
								...
								<div class="theme-screenshot">
									<img src="<?php echo YATRI_TOOLS_PLUGIN_URI.'demos/'.$demo.'/'.$demo; ?>.png" />
								...
								<div class="theme-id-container">
									...
									<div class="theme-actions">
										<a class="button button-primary" href="#" target="_blank"><?php _e( 'Live Preview', 'yatri-tools-toolkit' ); ?></a>
									</div>
